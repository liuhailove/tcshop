...
public class PlayListDetailCreator {
    ...
    private PlayListDetailCreatorAvatarDetail avatarDetail;
    ...
    public PlayListDetailCreatorAvatarDetail getAvatarDetail() {
        return avatarDetail;
    }

    public void setAvatarDetail(PlayListDetailCreatorAvatarDetail avatarDetail) {
