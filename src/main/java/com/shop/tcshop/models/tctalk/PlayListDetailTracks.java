...
public class PlayListDetailTracks {
    private String name;
    private int id;
    private int pst;
    private int t;
    private List<PlayListDetailTracksAr> ar;
    ...
    private String crbt;
    private String cf;
    private PlayListDetailTracksAl al;
    private int dt;
    private PlayListDetailTracksH h;
    private PlayListDetailTracksM m;
    private PlayListDetailTracksL l;
    private String a;
    private String cd;
    private int no;
    ...
    public List<PlayListDetailTracksAr> getAr() {
        return ar;
    }

    public void setAr(List<PlayListDetailTracksAr> ar) {
        this.ar = ar;
    }
    ...
    public PlayListDetailTracksAl getAl() {
        return al;
    }

    public void setAl(PlayListDetailTracksAl al) {
        this.al = al;
    }
    ...
    public PlayListDetailTracksH getH() {
        return h;
    }

    public void setH(PlayListDetailTracksH h) {
        this.h = h;
    }

    public PlayListDetailTracksM getM() {
        return m;
    }

    public void setM(PlayListDetailTracksM m) {
        this.m = m;
    }

    public PlayListDetailTracksL getL() {
        return l;
    }

    public void setL(PlayListDetailTracksL l) {
        this.l = l;
    }
